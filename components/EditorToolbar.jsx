      ...
      <ReactModal isOpen={editingLink}>
        <div className="flex flex-col">
          ...
          <div className="flex justify-between">
            <button className="btn" onClick={onUpdateLink}>
              update link
            </button>
            {currentActiveLink && <button onClick={onUnlink}>unlink</button>}
            <button className="btn" onClick={() => setEditingLink(false)}>
              cancel
            </button>
          </div>
        </div>
...
export default function EditorToolbar({
  ...
  return (
    <div className={`flex justify-between ${className || ""}`} {...props}>
      <div className="flex">
        <MarkButton title="Bold" format="bold">
          <FormatBold />
        </MarkButton>
        <MarkButton title="Italic" format="italic">
          <FormatItalic />
        </MarkButton>
        <MarkButton title="Underline" format="underline">
          {" "}
          <FormatUnderlined />
        </MarkButton>
        <LinkButton />
